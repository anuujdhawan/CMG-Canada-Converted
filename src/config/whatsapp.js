// WhatsApp configuration is server-only. The final href is passed to the
// browser only where the UI needs to open WhatsApp.
const raw = (process.env.WHATSAPP_URL || "").trim();
