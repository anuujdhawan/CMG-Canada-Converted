...
export default function GuidedChatbot() {
  ...
  return (
    <div className={`cmg-chatbot-root fixed right-5 !bottom-[8.75rem] z-[80] w-[3.75rem] max-[640px]:right-[.75rem] max-[640px]:!bottom-32 max-[640px]:w-[3.5rem] ${!open ? "flex items-center justify-center !w-12 max-[1023.98px]:!w-[2.75rem]" : ""} ${open ? "cmg-chatbot-root--open max-[640px]:top-[var(--brand-hero-pad-top)] max-[640px]:left-[.75rem] max-[640px]:bottom-[5.4rem] max-[640px]:w-auto" : ""}`}>
      {open ? (
